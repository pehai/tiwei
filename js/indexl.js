...
var S = {
  init: function () {
    ...
    // 設定輸出容器
      const container = document.querySelector('#output') || document.querySelector('.terminal') || document.body;
      container.style.background = "rgba(135, 206, 235, 0.8)";
      container.style.color = "white";
      S.UI.simulate('Hi 迪腿|祝你|生日快樂|Happy Birthday！|');
    }
